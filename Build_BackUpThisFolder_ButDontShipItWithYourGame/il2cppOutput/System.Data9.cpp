...
IL2CPP_EXTERN_C IL2CPP_NO_INLINE IL2CPP_METHOD_ATTR RuntimeObject* SqlUdtStorage_ConvertXmlToObject_m64771B8D93840BFF00509C689682D9EE9F107EE2 (SqlUdtStorage_t5F263716B666F5A31BD1DC9AC94981BF3185F067* __this, XmlReader_t4C709DEF5F01606ECB60B638F1BD6F6E0A9116FD* ___xmlReader0, XmlRootAttribute_t09EE81719C9B95C01B28D108765FB62737E75FAF* ___xmlAttrib1, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_1);
		String_t* L_2;
		L_2 = VirtualFuncInvoker2< String_t*, String_t*, String_t* >::Invoke(24 /* System.String System.Xml.XmlReader::GetAttribute(System.String,System.String) */, L_1, _stringLiteralF5272508B2E6395FDF44F8E7BE3B299EB6377D28, _stringLiteral44796A9EA3476CDED88CE39A688C638A52C1D20E);
		V_0 = L_2;
		String_t* L_3 = V_0;
		if (L_3)
		{
	...
	}
	{
		...
		NullCheck(L_4);
		String_t* L_5;
		L_5 = VirtualFuncInvoker2< String_t*, String_t*, String_t* >::Invoke(24 /* System.String System.Xml.XmlReader::GetAttribute(System.String,System.String) */, L_4, _stringLiteralF5272508B2E6395FDF44F8E7BE3B299EB6377D28, _stringLiteral7C014955313A7D33D5D04696B884B25325E6393C);
		V_1 = L_5;
		String_t* L_6 = V_1;
		if (!L_6)
		{
